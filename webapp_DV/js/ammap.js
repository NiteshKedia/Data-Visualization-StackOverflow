...
(function() {
    ...
    d.wrappedText = function(a, b, c, h, f, e, g, k, l) {
        ...
        if (m) {
            ...
            if (p.width > k) {
                ...
                if (isNaN(r)) {
                    if (0 === l)
                        for (u = 1; u < p; u++) r = Math.round(b.length / p * u), b = b.substr(0, r) + n +
                            b.substr(r);
    ...
    d.formatDuration = function(a, b, c, h, f, e) {
        ...
        if (g[f].count > g[b].count)
            for (a = g[b].count; a < g[f].count; a++) b = g[b].nextInterval, "ss" == b || "mm" == b || "hh" == b ? c = "00" + h[b] + "" + c : "DD" == b && (c = "0" + h[b] + "" + c);
    ...
    d.parseDefs = function(a, b) {
        for (var c in a) {
            var h = typeof a[c];
            if (0 < a[c].length && "object" == h)
                for (var f = 0; f < a[c].length; f++) h = document.createElementNS(d.SVG_NS, c), b.appendChild(h), d.parseDefs(a[c][f], h);
            else "object" == h ? (h = document.createElementNS(d.SVG_NS, c), b.appendChild(h), d.parseDefs(a[c], h)) : b.setAttribute(c, a[c])
        }
    }
})();
(function() {
...
(function() {
    ...
    d.SVGRenderer = d.Class({
        ...
        setAttr: function(a, b, c) {
            if(c == "translate(0,0) scale(Infinity)") {
                //c = "translate(20,30) scale(0.70)";
                c = "translate(0,15) scale(0.7240124032839743)";
            }
    ...
    d.AmChart = d.Class({
        ...
        measure: function() {
            ...
            if (a) {
                ...
                e = a.style;
                a = e.width;
                e = e.height; - 1 != a.indexOf("px") && (c = d.removePx(a)); - 1 != e.indexOf("px") && (h = d.removePx(e));
                h = Math.round(h);
                c = Math.round(c);
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var k = q + B,
                        ...
                        E = this.bulletSize,
                        F;
                    0 < x || 0 === w ? (0 < B && (a = d.rect(f, z, y, p, 0, A + 1, G, B, this.cornerRadius), d.isModern ?
                        ...
                        r, x, p, this.fillAlpha, A, u, this.borderAlpha));
                    this.bg = p;
                    e.push(p);
                    p.toFront();
...
(function() {
    ...
    d.makeHD = function(a, b, c) {
        for (var d = [], f = [], e = 1; e < a.length; e++)
            for (var g = Number(a[e - 1]), k = Number(b[e - 1]), l = Number(a[e]), m = Number(b[e]), n = Math.sqrt(Math.pow(l - g, 2) + Math.pow(m - k, 2)), n = Math.round(n / 50) + 1, l = (l - g) / n, m = (m - k) / n, p = 0; p <= n; p++) {
    ...
    d.handDrawnLine =
        function(a, b, c, h, f, e, g, k, l, m) {
            var n, p = a.set();
            for (n = 1; n < b.length; n++)
                for (var u = [b[n - 1], b[n]], r = [c[n - 1], c[n]], r = d.makeHD(u, r, a.handDrawScatter), u = r[0], r = r[1], A = 1; A < u.length; A++) p.push(d.line(a, [u[A - 1], u[A]], [r[A - 1], r[A]], h, f, e + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, k, l, m, !0));
            return p
    };
    ...
    d.wedge = function(a, b, c, h, f, e, g, k, l, m, n, p) {
        ...
        h = a.set();
        var G;
        A && (B = u(10 * B), x = u(10 * x), q = u(10 * q), t = u(10 * t), D = u(10 * D), y = u(10 * y), v = u(10 * v), w = u(10 * w), b = u(10 * b), l = u(10 * l), c = u(10 * c), e *= 10, g *= 10, k *= 10, r *= 10, 1 > Math.abs(f) && 1 >= Math.abs(q - x) && 1 >= Math.abs(v -
            y) && (G = !0));
        f = "";
        var E;
        ...
        A ? (G || (f = " A" + u(b - e) + "," + u(c - g) + "," + u(b + e) + "," + u(c + g) + "," + u(x) + "," + u(y) + "," + u(q) + "," + u(v)), e = " M" + u(B) + "," + u(D) + " L" + u(x) + "," + u(y) + f + " L" + u(t) + "," + u(w)) : e = " M" + B + "," + D + " L" + x + "," + y + (" A" + e + "," + g + ",0," + C + ",1," + q + "," + v) + " L" + t + "," +
            w;
    ...
    d.AmLegend = d.Class({
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend) {
                ...
                var A;
                h && (h = d.fixBrakes(h), a.legendTextReal = h, A = this.labelWidth, A = isNaN(A) ? d.text(this.container, h, e, b.fontFamily, c, "start") : d.wrappedText(this.container, h, e, b.fontFamily,
                    c, "start", !1, A, 0), d.setCN(b, A, "legend-label"), A.translate(this.lx + n, this.ly), l.push(A), b = A.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
        ...
        updateValues: function() {
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if (d) e.value ? f.text(e.value) : f.text("");
                    ...
                    } else g = b.formatString(this.valueText, e); if (l = this.valueFunction) k && (e = k), g = l(e, g);
                    f.text(g)
                }
            }
        },
    ...
    d.AmMap = d.Class({
                ...
                if (!isNaN(k)) {
                    ...
                    if (!isNaN(r)) {
                        var A = 5 * Math.abs(r - k) / l,
                            ...
                            r = (b.zoomY() - r * A) * (l / g) + r * A;.1 < Math.abs(l - g) && (b.zoomTo(l, B, r, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
                    }
                    b.previousDistance =
                        k
                }
        ...
        selectObject: function(a) {
            ...
            if (c) {
                ...
                for (g = b.getGroupById(c), k = 0; k < g.length; k++) {
                    var l = g[k];
                    l.isOver = !1;
                ...
                for (f = 0; f < k; f++) {
                    ...
                    if (0 !== e.childNodes.length || "" !== m || !1 !== n)
                        ...
                        if (e.attributes && e.attributes.length)
                            for (m = 0; m < e.attributes.length; m++) p[e.attributes[m].name] = e.attributes[m].value;
...
(function() {
    ...
    d.ZoomControl = d.Class({
        construct: function(a) {
            ...
            this.gridBackgroundColor = "#A3E2F4";
        ...
        init: function(a, b) {
           ...
           /* if (e) {
                ...
                var y = Math.log(D / w) / Math.log(B) + 1,
                    e = A / y,
                    t;
                for (t = 1; t < y; t++) q = f + t * e, q = d.line(b, [1, f - 2], [q, q], c.gridColor, c.gridAlpha, 1), d.setCN(a,
                    q, "zoom-grid"), v.push(q);
                q = new d.SimpleButton;
            ...
            /*g && (g = b.set(), d.setCN(a, g, "zoom-control-pan"), h.push(g), v && v.translate(f, 4 * f), v = new d.SimpleButton, v.setIcon(a.pathToImages + "panLeft.gif", c.iconSize), v.setClickHandler(a.moveLeft,
...
(function() {
    ...
    d.ImagesProcessor = d.Class({
        ...
        updateSizeAndPosition: function(a) {
            ...
            else if (!isNaN(k) && !isNaN(g) && (d = b.longitudeToCoordinate(g), f = b.latitudeToCoordinate(k), c.translate(d, f, NaN, !0), a.fixedSize)) {
                d = 1;
                ...
                if (t.remainVisible || c.selectedObject == t.parentObject) {
                    ...
                    if (0 < H.length) {
                        ...
                        if ("none" != M) {
                            ...
                            "middle" == M && (F = H[H.length - 1], E = J[J.length - 1], 1 < H.length ? (K = H[H.length - 2], I = J[J.length -
                                2]) : (K = F, I = E), R = K + (F - K) / 2, T = I + (E - I) / 2, I = 180 * Math.atan((E - I) / (F - K)) / Math.PI, I = 0 > F - K ? I - 90 : I + 90);
    ...
    d.ValueLegend = d.Class({
        ...
        init: function(a, b) {
            if (this.enabled) {
                ...
                if (this.showAsGradient) c = d.rect(b, this.width, this.height, [c, h], 1, this.borderThickness, this.borderColor, 1, 0, 0), d.setCN(a, c, "value-legend-gradient"), c.translate(0, g), e.push(c);
                else
                    for (l = this.width / f, m = 0; m < f; m++) n = d.getColorFade(c, h, 1 * m / (f - 1)), n = d.rect(b, l, this.height, n, 1, this.borderThickness, this.borderColor, 1), d.setCN(a, n, "value-legend-color"), d.setCN(a, n, "value-legend-color-" + m), n.translate(l * m, g), e.push(n);
                h = c = 0;
                f = e.getBBox();
